...
export const INITIAL_TICKETS: Ticket[] = [
  ...
  {
    k: 'GAR-140', st: 'diag', type: 'diag', epic: 'elec', prio: 'high', pts: 2, who: 'dk', job: 'W-1041',
  ...
  {
    k: 'GAR-147', st: 'diag', type: 'test', epic: 'body', prio: 'med', pts: 1, who: 'ns', job: 'W-1047',
  ...
  {
    k: 'GAR-148', st: 'qa', type: 'job', epic: 'service', prio: 'med', pts: 2, who: 'dk', job: 'W-1040',
